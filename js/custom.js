...
/* _____________________________________
    ...
    if (pageAmplitude.length) {
      ...
      if (!isMobile && !isTouch) {
        var sound = new Howl({
          src: ['/audio/audio.webm', '/audio/audio.mp3'],
          autoplay: true,
          loop: true
        });
    ...
    function initMap(map) {
      ...
      var points = [
        ['<div class="wrapper"><h4>Saad Ahmad Office</h4><h5>Opening Hours</h5><p>Mo – Fr: 08:30 – 20:00</p></div>', 40.7486332, -73.9797129],
        ['<div class="wrapper"><h4>Saad Ahmad Agency</h4><h5>Opening Hours</h5><p>Mo – Fr: 08:30 – 20:00</p></div>', 40.66810, -73.94480]
      ];
      // marker
